...
import { githubLoginCallback, lineLoginCallback, facebookLoginCallback } from './controllers/userController';
...
passport.use(new FacebookStrategy({
    ...
    callbackURL: process.env.PRODUCTION
        ? `https://whispering-tor-64595.herokuapp.com${routes.facebookCallback}`
